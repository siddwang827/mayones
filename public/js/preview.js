function previewResume(resumeDetail) {
    ...
    if (resumeDetail.skill_name[0]) {
            ...
            return $(`
                <div class="profile-content">
                    <div class="resume-preview-content-item">
                        ...
                        ${
                            resumeDetail.skill_proficiency[index] === "初階"
                                ? "Beginner"
                                : resumeDetail.skill_proficiency[index] === "熟練"
                                ? "Advanced"
                                : "Expert"
                        }</div>
                    </div>
        ...
        skillsDivs.forEach((skill) => skillContainer.append(skill));
    }
    ...
    if (resumeDetail.project_title[0]) {
        ...
        projectDivs = resumeDetail.project_title.map((project, index) => {
            return $(`
                <div class="profile-content  project">
                    ...
                    <div class="project-col" style="background: url(${
                        resumeDetail.project_image[index] ? resumeDetail.project_image[index] : "/img/default.jpg"
                    }); background-size: contain; height: 185px; width: 280px; background-position: center; background-repeat: no-repeat;">
        ...
        projectDivs.forEach((project) => projectContainer.append(project));
    }
    ...
    if (resumeDetail.experience_title[0]) {
        ...
        experienceDivs.forEach((experience) => experienceContainer.append(experience));
    }
    ...
    if (resumeDetail.education_title[0]) {
        ...
        educationDivs.forEach((education) => educationContainer.append(education));
    }
