...
$(".image-title").on("click", removeUpload);
    ...
    if (input.files && input.files[0]) {
        ...
        if (imgClass === "others") {
            ...
            reader.onload = function (e) {
                ...
                $(`#image-title-${imgClass}-${index}`).attr("index", index);
                $(`#image-title-${imgClass}-${index}`).attr("image-class", imgClass);
            };
        } else {
            reader.onload = function (e) {
                ...
                $(`#image-title-${imgClass}`).attr("image-class", imgClass);
            };
        }
