...
const getCompanies = async (req, res) => {
    ...
    try {
        ...
        return res.render("companies", { companies, header, companyLocations, companyCatories, companyTags });
    } catch (err) {
        console.log(err);
...
const getCompanyDetail = async (req, res) => {
    ...
    try {
        ...
        return res.render("companyDetail", { companyDetail, thoundsAddComma, header });
    } catch (err) {
        console.log(err);
        res.status(500).render("500", { header: {} });
    }
