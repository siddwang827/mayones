...
async function _createFakeCompanies(conn) {
    const sql =
        "INSERT INTO companies (owner_id, brand, website, category, short_description, company_location, company_address, introduction, philosophy, story, benifit, logo_image, banner_image) VALUES ?";
...
async function _createFakeJobs(conn) {
    const sql =
        "INSERT INTO jobs (owner_id, companies_id, job_title, job_description, skill_required, prefered_qualification, salary_bottom, salary_top, salary_type, job_type, location, address, remote_work, category_position_id) VALUES ?";
